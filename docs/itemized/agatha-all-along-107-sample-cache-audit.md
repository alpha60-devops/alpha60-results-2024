...
{% include_relative figures/agatha-all-along-107-downloads-by-week-agatha-all-along-107-week.svg %}
</div>
<style>
...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2024/refs/heads/main/data/geojson.cumulative/agatha-all-along-107-cumulative-aggregate.geojson.gz" data-map-title="Agatha All Along — agatha-all-along-107" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Agatha All Along (agatha-all-along-107) cumulative data map in new window" title="Opens interactive map for Agatha All Along (agatha-all-along-107) data">Swarm Detail</a>
...
[![Cumulative >= 1080p](figures/agatha-all-along-107-data-ge-1080p.webp)](figures/agatha-all-along-107-data-ge-1080p-4k.webp){:target="_blank" rel="noopener"}

### Resolution < 1080p

[![Cumulative < 1080p](figures/agatha-all-along-107-data-lt-1080p.webp)](figures/agatha-all-along-107-data-lt-1080p-4k.webp){:target="_blank" rel="noopener"}
