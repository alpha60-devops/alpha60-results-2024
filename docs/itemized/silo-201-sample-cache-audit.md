...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2024/refs/heads/main/data/geojson.cumulative/silo-201-cumulative-aggregate.geojson.gz" data-map-title="Silo — silo-201" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Silo (silo-201) cumulative data map in new window" title="Opens interactive map for Silo (silo-201) data">Swarm Detail</a>
