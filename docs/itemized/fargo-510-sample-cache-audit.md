...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2024/refs/heads/main/data/geojson.cumulative/fargo-510-cumulative-aggregate.geojson.gz" data-map-title="Fargo — fargo-510" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Fargo (fargo-510) cumulative data map in new window" title="Opens interactive map for Fargo (fargo-510) data">Swarm Detail</a>
