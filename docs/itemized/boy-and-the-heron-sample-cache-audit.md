...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2024/refs/heads/main/data/geojson.cumulative/boy-and-the-heron-cumulative-aggregate.geojson.gz" data-map-title="The Boy and the Heron — boy-and-the-heron" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open The Boy and the Heron (boy-and-the-heron) cumulative data map in new window" title="Opens interactive map for The Boy and the Heron (boy-and-the-heron) data">Swarm Detail</a>
