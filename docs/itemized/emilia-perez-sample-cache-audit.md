...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2024/refs/heads/main/data/geojson.cumulative/emilia-perez-cumulative-aggregate.geojson.gz" data-map-title="Emilia Perez — emilia-perez" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Emilia Perez (emilia-perez) cumulative data map in new window" title="Opens interactive map for Emilia Perez (emilia-perez) data">Swarm Detail</a>
