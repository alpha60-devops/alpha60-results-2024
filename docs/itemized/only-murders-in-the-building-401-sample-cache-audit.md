...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2024/refs/heads/main/data/geojson.cumulative/only-murders-in-the-building-401-cumulative-aggregate.geojson.gz" data-map-title="Only Murders In the Building — only-murders-in-the-building-401" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Only Murders In the Building (only-murders-in-the-building-401) cumulative data map in new window" title="Opens interactive map for Only Murders In the Building (only-murders-in-the-building-401) data">Swarm Detail</a>
