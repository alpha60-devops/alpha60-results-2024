...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2024/refs/heads/main/data/geojson.cumulative/acolyte-101-cumulative-aggregate.geojson.gz" data-map-title="The Acolyte — acolyte-101" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open The Acolyte (acolyte-101) cumulative data map in new window" title="Opens interactive map for The Acolyte (acolyte-101) data">Swarm Detail</a>
