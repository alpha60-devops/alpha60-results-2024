...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2024/refs/heads/main/data/geojson.cumulative/wild-robot-cumulative-aggregate.geojson.gz" data-map-title="Wild Robot — wild-robot" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Wild Robot (wild-robot) cumulative data map in new window" title="Opens interactive map for Wild Robot (wild-robot) data">Swarm Detail</a>
