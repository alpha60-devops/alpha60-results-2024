...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2024/refs/heads/main/data/geojson.cumulative/arcane-02.3-cumulative-aggregate.geojson.gz" data-map-title="Arcane — arcane-02.3" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Arcane (arcane-02.3) cumulative data map in new window" title="Opens interactive map for Arcane (arcane-02.3) data">Swarm Detail</a>
