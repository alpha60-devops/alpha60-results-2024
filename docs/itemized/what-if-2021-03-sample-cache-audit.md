...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2024/refs/heads/main/data/geojson.cumulative/what-if-2021-03-cumulative-aggregate.geojson.gz" data-map-title="What if? — what-if-2021-03" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open What if? (what-if-2021-03) cumulative data map in new window" title="Opens interactive map for What if? (what-if-2021-03) data">Swarm Detail</a>
