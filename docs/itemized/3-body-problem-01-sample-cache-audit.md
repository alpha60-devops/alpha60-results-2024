...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2024/refs/heads/main/data/geojson.cumulative/3-body-problem-01-cumulative-aggregate.geojson.gz" data-map-title="3 Body Problem — 3-body-problem-01" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open 3 Body Problem (3-body-problem-01) cumulative data map in new window" title="Opens interactive map for 3 Body Problem (3-body-problem-01) data">Swarm Detail</a>
