...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2024/refs/heads/main/data/geojson.cumulative/brothers-sun-01-cumulative-aggregate.geojson.gz" data-map-title="The Brothers Sun — brothers-sun-01" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open The Brothers Sun (brothers-sun-01) cumulative data map in new window" title="Opens interactive map for The Brothers Sun (brothers-sun-01) data">Swarm Detail</a>
